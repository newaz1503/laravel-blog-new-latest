                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" name="title" value="{{$post->title}}" id="email_address" class="form-control" placeholder="Enter Post title">
                                </div>
                                @if ($errors->has('title'))
                            ...
                            <div class="form-group">
                                ...
                                <div class="m-t-10">
                                    <img src="{{asset('storage/post/'.$post->image)}}" alt="{{Str::limit($post->title, 5)}}" width="60" height="40">
                                </div>
                                @if ($errors->has('image'))
                                    <span class="invalid feedback" role="alert">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                                        ...
                                        @foreach($categories as $category)
                                             <option
                                                 @foreach($post->categories as $postCat)
                                                         {{$category->id == $postCat->id ? 'selected' : ''}}
                                                  @endforeach
                            ...
                            <a href="{{route('author.post')}}" class="btn btn-danger m-t-12 waves-effect">Back</a>
                        </div>
                    </div>
                </div>
            </div>
